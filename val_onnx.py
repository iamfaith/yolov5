    ...
    if opt.task in ('train', 'val', 'test'):  # run normally
        ...
        if opt.task == 'speed':  # speed benchmarks
            ...
            for opt.weights in weights:
                ...
                x, y = [640], []  # x axis (image sizes), y axis
...
# /home/faith/miniconda3/envs/torch_cuda_11.3/bin/python val.py --task study --data /home/faith/yolov5/data/coco_person.yaml --iou 0.45 --weights /home/faith/yolov5/exp4/weights/best.pt --device cpu --conf-thres 0.15

# /home/faith/miniconda3/envs/torch_cuda_11.3/bin/python val.py --task study --data /home/faith/yolov5/data/coco_person.yaml --iou 0.45 --weights /home/faith/yolov5/yolov5n6-6.2.pt --device cpu --conf-thres 0.25
...
Usage:
    ...
    /home/faith/miniconda3/envs/torch_cuda_11.3/bin/python /home/faith/yolov5/train.py --data coco_person.yaml --weights /home/faith/yolov5/runs/train/exp3/weights/best.pt --cfg yolov5n-ghost-v3.yaml --img 640 --batch 256

    
    /home/faith/miniconda3/envs/torch_cuda_11.3/bin/python /home/faith/yolov5/train.py --data coco_person.yaml --weights /home/faith/yolov5/runs/train/exp4/weights/best.pt --cfg yolov5n-ghost-v3-512.yaml --img 640 --batch 256 --workers 2
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default="/home/faith/yolov5/exp4/weights/best.pt", help='initial weights path')
    # parser.add_argument('--weights', type=str, default='', help='initial weights path')   ########## change
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/yolov5n-ghost-v3.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/home/faith/pingpong.v2i.yolov5pytorch/data.yaml', help='dataset.yaml path')   
    # parser.add_argument('--data', type=str, default=ROOT / 'data/coco_person.yaml', help='dataset.yaml path')   ########## change
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch-low.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=350) ########## change

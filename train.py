...
def parse_opt(known=False):
    ...
    # parser.add_argument('--weights', type=str, default="/home/faith/yolov5/runs/train/exp2/weights/best.pt", help='initial weights path')
    parser.add_argument('--weights', type=str, default='/home/faith/yolov5s.pt', help='initial weights path')   ########## change
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/mc.yaml', help='dataset.yaml path')   ########## change
